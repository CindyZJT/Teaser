...
class IUXRAY_Dataset(Dataset):
    def __init__(self, *args, **kwargs):
        ...
        #self.ann_path = os.path.join(args[0], "clean_annotation.json")
        ...
        if self.split=="train":
            self.transform = transforms.Compose([
                ...
                transforms.RandomCrop(self.image_size,pad_if_needed=True,padding_mode='edge'),
        ...
        path = os.path.join(kwargs["pre_data_path"], "iuxray_{}.pkl".format(self.split))
        f = open(path, "rb")
    ...
    def __getitem__(self, index):
        ...
        #image
        #print(os.path.join(self.image_dir, image_path[0]))
        #print(os.path.join(self.image_dir, image_path[1]))
