...
class TransformerSQ_CNN(pl.LightningModule):
    def __init__(self, config, tokenizer):
        ...
        # ===================== Downstream ===================== #
        if (self.transformerSQHparams.config["load_path"] != "" and not self.transformerSQHparams.config["test_only"]):
            print(self.transformerSQHparams.config["test_only"])
        ...
        if self.transformerSQHparams.config["loss_names"]["vqa"] > 0:
            vs = self.transformerSQHparams.config["vqav2_label_size"]
        ...
        if self.transformerSQHparams.config["loss_names"]["nlvr2"] > 0:
        ...
        #if self.transformerSQHparams.config["loss_names"]["mimic"] > 0:
            #vs = self.transformerSQHparams.config["vqav2_label_size"]
    ...
    def test_epoch_end(self, outs):
        #model_name = self.transformerSQHparams.config["load_path"].split("/")[-1][:-5]
